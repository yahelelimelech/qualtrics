...
var instructions_block = {
    ...
    `<img style ='display: block; margin: auto;max-width: 50%;' src=  'https://i.ibb.co/sv67STv/inst-word2.png' alt='Picture'>` +
    "<p>For example, this item is <strong>blue, circle, and checkers</strong>.</p>",
        ...
        `<img style='display: block; margin: auto; max-width: 50%;'src= 'https://i.ibb.co/Ldcpm5j/inst-word.png' alt='Picture'>` +
